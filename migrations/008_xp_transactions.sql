-- Migration 008: Tabela de transações de XP

-- Criar tabela de transações de XP
CREATE TABLE IF NOT EXISTS xp_transactions (
  ...
  reference_id UUID, -- ID da partida, badge, desafio, etc
...
-- Função para registrar transação de XP
...
-- Modificar triggers existentes para usar add_xp_transaction
